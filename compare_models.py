...
Execution
    ...
    Command-line execution allows adjustment of settings: python compare_models_final.py input_1.stl(or .csv) input2.stl(or .csv) --options
    Options:
    ...
    donwload .exe application of the user-interface script form google drive
...
Information:
    ...
    - Recommended setting for matplotlib: Density 3, Transparency 0.05-0.2 Density 2, Transparency 0.04-0.1 Density 1, Transparency 0.01-0.02
